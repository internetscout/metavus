<?PHP
#
#   FILE:  PluginUpgrade_1_2_14.php (MetricsRecorder plugin)
#
...
/**
 * Class for upgrading the MetricsRecorder plugin to version 1.2.14.
 */
class PluginUpgrade_1_2_14 extends PluginUpgrade
{
    # ---- PUBLIC INTERFACE --------------------------------------------------

    /**
     * Perform actions necessary to upgrade plugin to version 1.2.14.
