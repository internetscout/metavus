...
* @param string $StatusString Text status description
* @return Corresponding integer status code
*/
...
* @param string $StatusCodes Array of status codes
...
$DefaultConstraintList->AddConstraint(new Constraint("Hidden", 0, "="));
...
if ($OrderBy == "Title") {
    $OrderBy = $TitleField;
} elseif ($OrderBy == "ReleaseDate") {
    $OrderBy = $ReleaseDateField;
}
