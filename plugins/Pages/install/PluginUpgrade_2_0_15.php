<?PHP
#
#   FILE:  PluginUpgrade_2_0_15.php (Pages plugin)
#
...
/**
 * Class for upgrading the Pages plugin to version 2.0.15.
 */
class PluginUpgrade_2_0_15 extends PluginUpgrade
{
    # ---- PUBLIC INTERFACE --------------------------------------------------

    /**
     * Perform actions necessary to upgrade plugin to version 2.0.15.
